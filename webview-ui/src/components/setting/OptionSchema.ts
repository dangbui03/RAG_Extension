...
export const retrieverOptionsSchema = z.object({
  ...
  top_k: z
    ...
    .max(10, "Top-k must be at most 10.")
    .default(5),
...
export const generatorOptionsSchema = z.object({
  ...
  mirostat_tau: z
    .number()
    .min(0, "Mirostat tau must be between 0 and 5.")
    .max(5, "Mirostat tau must be between 0 and 5.")
    .default(5),
  ...
  num_ctx: z
    ...
    .max(4096, "Context length must be at most 4096.")
    .default(2048),

  repeat_last_n: z
    .number()
    .int("Repeat-last-N must be an integer.")
    .min(0, "Repeat-last-N must be at least 0.")
    .max(100, "Repeat-last-N must be at most 100.")
    .default(33),
  ...
  seed: z
    ...
    .max(1000, "Seed must be at most 1000.")
    .default(42),
  ...
  num_predict: z
    ...
    .min(1, "Num-predict must be at least 1.")
    .max(1000, "Num-predict must be at most 1000.")
    .default(42),
